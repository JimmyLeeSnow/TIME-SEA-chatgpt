...
Date: 2023-05-14 21:27:23
LastEditors: yun.huang <1594909346@qq.com>
LastEditTime: 2023-05-14 21:41:47
Version: 1.0.1
...
from super_python import settings

# 数据库表名前缀
table_prefix = "super_python_"
...
class CoreModel(models.Model):
    ...
    id = models.CharField(max_length=100, primary_key=True,
                          default=make_uuid, help_text="Id", verbose_name="Id")
    description = models.CharField(
        max_length=100, verbose_name="描述", null=True, blank=True, help_text="描述")
    creator = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_query_name='creator_query', null=True,
                                verbose_name='创建人', help_text="创建人", on_delete=models.SET_NULL, db_constraint=False)
    modifier = models.CharField(
        max_length=100, null=True, blank=True, help_text="修改人", verbose_name="修改人")
    dept_belong_id = models.CharField(
        max_length=100, help_text="数据归属部门", null=True, blank=True, verbose_name="数据归属部门")
